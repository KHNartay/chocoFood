async function createCard() {
    ...
    document.querySelector('card-one span').textContent = data[1].price;
    ...
    document.querySelector('card-one span').textContent = data[2].price;
    ...
    document.querySelector('card-one span').textContent = data[3].price;
